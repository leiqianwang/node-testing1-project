...
describe('[Exercise 3] findLargestInteger', () => {
   ...
   // it('should return the largest number', () => {
           const integerObj = [{integer: 3, integer: 18, integer: 2, integer: 35}];
           const expected = 35;
           const actual = utils.findLargestInteger(integerObj);
           expect(actual).toBe(expected);
    });
    it("throw 'Not object! if the argument is not an object", () => {
      expect(() => utils.findLargestInteger(3).toThrow('Not object!'));
      expect(() => utils.findLargestInteger('thirteen and five').toThrow('Not object!'));
      expect(() => utils.findLargestInteger(undefined).toThrow('Not object!'));
   // })
    })
})
